...
void loop() {
  if(Firebase.ready() && signupOK && (millis()-sendDataPrevMillis>2000 || sendDataPrevMillis == 0))
  {
    ...
    */
    ...
    // below is for getting temperature value 
    if(Firebase.RTDB.setFloat(&fbdo, "Sensor/Temperature", tempdata))
    {
      Serial.println();
   ...
   //below is for getting humditity value
  if(Firebase.RTDB.setFloat(&fbdo, "Sensor/Humidity", humiddata))
    {
      Serial.println();
